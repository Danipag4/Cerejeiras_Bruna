...
df = pd.read_csv("Gestor_Bruna.csv", sep=",")
...
if AvalEquipe:
    ...
    fig_Setor = px.bar(df_MédiaSetor, x=aval, y="Nome", orientation="h", height=500,barmode='group', color_discrete_map = {"Autoavaliação":"#281BD2", "Gestor":"#B77943"})
